...
public class ImageController {
    ...
    public String handleImagePost(@ModelAttribute("book") Book book, BindingResult bindingResult,@PathVariable String id, @RequestParam("imagefile") MultipartFile file) throws IOException {
