...
insert into book(id,add_date, category, cover, number_of_pages, title, url_pdf, book_info_id, pub_house_id) values(1, CURDATE(), 'Art',	null, 455, 'title', '1.pdf', 1, 2);
...
insert into online_library.users_roles values (2,2);
